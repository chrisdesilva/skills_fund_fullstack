...
const LoanApp = React.forwardRef((props, ref) => {
	...
	//         ReactGA.event({
	//             category: 'Apply Now Button | Fullstack',
	//             action: 'click',
	...
	return (
		<div ref={ref} className="flex flex-col items-center justify-center pt-8 bg-purple-150 lg:w-1/2 h-full">
			...
			<div className="rounded shadow-2xl pt-4 px-8 mx-4 bg-white">
				...
				<form className={formName} onSubmit={handleSubmit}>
						...
						<div className="w-full lg:w-64 px-8 lg:px-0">
							...
							<Collapse isOpened={programNotice}>
								<p className="mb-0 pb-4">
									<strong>Please note: </strong>The max tuition for Cyber Bootcamp Part-Time is
									$15,980. Cost of living is not available. If you add cost of living to your
									application it will be removed during the application process.
								</p>
							</Collapse>
						</div>
					)}
					...
					<input
						className="border-2 rounded border-primary text-center py-2 mb-2 w-64"
						type="email"
						name="email"
			...
			<div className="px-8 text-sm">
				...
				<p
					className="text-center underline cursor-pointer font-bold my-4"
